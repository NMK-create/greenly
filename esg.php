...
<main tabindex="-1">
    ...
    <section class="container">
        <div class="g-5 row">
            ...
            <div class="col-md-6">
                <section aria-labelledby="sektion-social-sociale-forhold">
                    ...
                    <p>
                        Der skal også være en politik i virksomheden, der fremmer inklusion af forskellige køn,
                        handicap, etnicitet og LGBT+ personer.
                    </p>
                </section>
            </div>

            <div class="col-md-6">
                <section aria-labelledby="sektion-governance-god-selskabsledelse">
                    <h2 id="sektion-governance-god-selskabsledelse">Governance / God selskabsledelse</h2>
                    <p>
                        Her kigger man på, hvordan virksomheden eller organisationen ledes og styres, f.eks. ved at have
