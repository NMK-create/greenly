        ...
        <section aria-labelledby="kontakt-formular" class="contact-section">
            ...
            <form class="row g-4" action="#" method="post" novalidate>
                ...
                <div class="col-md-6">
                    ...
                    <input id="name" name="name" type="text" autocomplete="name" required class="form-control"
                           placeholder="Dit fuldenavn">
                </div>
